...
for page in pages:
    ...
    response = get('https://www.amazon.com/best-sellers-books-Amazon/zgbs/books/ref=zg_bs_pg_' + page + '?_encoding=UTF8&pg=' + page, headers = headers)
    ...
    for container in mv_containers:
        ...
        if container.find('span', class_ = 'p13n-sc-price'):
            pricing = container.find('span', class_ = 'p13n-sc-price').text
...
with open('output/com_book.csv', 'w') as the_file:
